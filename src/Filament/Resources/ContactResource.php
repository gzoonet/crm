...
use YourVendor\CrmPackage\Filament\Resources\ContactResource\Pages;
        ...
        return $form
            ->schema([
                ...
                Forms\Components\TextInput::make('position')
                    ->maxLength(255),
                Forms\Components\Textarea::make('notes') // This is the main notes field for the contact, not the polymorphic notes.
                    ->columnSpanFull(),
                TagsInput::make('tags') // Add TagsInput field
                    ...
                    ->relationship('tags', 'name') // Assumes 'tags' relationship exists on Contact model and 'name' is the display attribute on Tag model
                    ->columnSpanFull(),
            ]);
    }
